...
ax.legend(handles = [spine_patch, shaft_patch, soma_patch], fontsize = 'x-small')
ax2.legend(handles = [spine_patch, shaft_patch, soma_patch], fontsize = 'x-small')
ax3.legend(handles = [spine_patch, shaft_patch, soma_patch], fontsize = 'x-small')
ax4.legend(handles = [spine_patch, shaft_patch, soma_patch], fontsize = 'x-small')
ax5.legend(handles = [spine_patch, shaft_patch, soma_patch], fontsize = 'x-small')
